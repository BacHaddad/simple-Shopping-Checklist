...
const deleteTasksBtn = document.querySelector('[data-delete-completed-tasks-button]');
...
const LOCAL_STORAGE_SELECTED_LIST_ID_KEY = 'task_selectedListId'
...
newTaskForm.addEventListener('submit', e => {
    ...
    const task = createTaskItem(taskName);
...
function createTaskItem(taskName) {
    return { id: new Date().valueOf().toString(), name: taskName, complete: false };
}
